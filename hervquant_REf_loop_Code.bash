...
sample_input_list=/path/to/fastq/list
sample_output_list=/path/to/sample/output/list

#Dictate Directories
Study_OutDIR=/path/to/output/dir
Hervquant_refDIR=/path/to/hervquant/ref/file
